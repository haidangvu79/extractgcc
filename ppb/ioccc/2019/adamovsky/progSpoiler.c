// NOTE for Frama-C: this file has been modified, since the comment '//@' is
// parsed by Frama-C as an invalid ACSL annotation. We added a `;` to it.
...
/*@ assigns \result, *s, *x \from *s, *x; //unsound */
