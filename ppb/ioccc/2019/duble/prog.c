// NOTE for Frama-C: this file has been modified ('s' renamed to 'Ss') to avoid
// some issues with preprocessing annotations in Frama-C's libc
...
srand(getpid (    )),strcpy(L,K),B=C,*L=Ss     ,           x.J=44,
