...
void sign_conv_001 ()
{
	...
	char ret;
	ret = a; /*Tool should detect this line as error*/ /*Integer sign lost because of unsigned cast *//*FC-alarm-but-noUB*/
        sink = ret;
}
...
void sign_conv_009 ()
{
	...
	s.a = 0x1f;
	s.ret = s.a;/*Tool should detect this line as error*/ /*Integer sign lost because of unsigned cast *//*FC-alarm-but-noUB*/
}
...
{
	unsigned int ret;
	ret = -1;/*Tool should detect this line as error*/ /*Integer sign lost because of unsigned cast *//*FC-alarm-but-noUB*/
        sink = ret;
}
...
void sign_conv_013 ()
{
	int a = -1;
	unsigned int ret;
	ret = (5 * a) + 4;/*Tool should detect this line as error*/ /*Integer sign lost because of unsigned cast *//*FC-alarm-but-noUB*/
        sink = ret;
}
...
void sign_conv_014 ()
{
	int a = 2;
	unsigned int ret;
	ret = (a * a) - 5;/*Tool should detect this line as error*/ /*Integer sign lost because of unsigned cast *//*FC-alarm-but-noUB*/
        sink = ret;
}
...
void sign_conv_015 ()
{
	sign_conv_015_gbl_ret = sign_conv_015_func_001();/*Tool should detect this line as error*/ /*Integer sign lost because of unsigned cast *//*FC-alarm-but-noUB*/
}
...
{
	sign_conv_016_gbl_ret = a;/*Tool should detect this line as error*/ /*Integer sign lost because of unsigned cast *//*FC-alarm-but-noUB*/
}
...
void sign_conv_017 ()
{
	sign_conv_017_gbl_ret = sign_conv_017_gbl_buf[3];/*Tool should detect this line as error*/ /*Integer sign lost because of unsigned cast *//*FC-alarm-but-noUB*/
}
...
void sign_conv_018 ()
{
	...
	unsigned int ret;
	a1 = a;
	ret = a1;/*Tool should detect this line as error*/ /*Integer sign lost because of unsigned cast *//*FC-alarm-but-noUB*/
        sink = ret;
}
...
void sign_conv_019 ()
{
	...
	a1 = a;
	a2 = a1;
	ret = a2;/*Tool should detect this line as error*/ /*Integer sign lost because of unsigned cast *//*FC-alarm-but-noUB*/
        sink = ret;
}
