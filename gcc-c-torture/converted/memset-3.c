  ...
  for (len = 0; len < MAX_COPY; len++)
    {
      ...
      if (p != u.buf){ printf("abort_main "); 		abort (); }
      check (0, len, '\0');
  ...
  for (len = 0; len < MAX_COPY; len++)
    {
      ...
      if (p != u.buf+1){ printf("abort_main "); 		abort (); }
      check (1, len, '\0');
  ...
  for (len = 0; len < MAX_COPY; len++)
    {
      ...
      if (p != u.buf+2){ printf("abort_main "); 		abort (); }
      check (2, len, '\0');
  ...
  for (len = 0; len < MAX_COPY; len++)
    {
      ...
      if (p != u.buf+3){ printf("abort_main "); 		abort (); }
      check (3, len, '\0');
  ...
  for (len = 0; len < MAX_COPY; len++)
    {
      ...
      if (p != u.buf+4){ printf("abort_main "); 		abort (); }
      check (4, len, '\0');
  ...
  for (len = 0; len < MAX_COPY; len++)
    {
      ...
      if (p != u.buf+5){ printf("abort_main "); 		abort (); }
      check (5, len, '\0');
  ...
  for (len = 0; len < MAX_COPY; len++)
    {
      ...
      if (p != u.buf+6){ printf("abort_main "); 		abort (); }
      check (6, len, '\0');
  ...
  for (len = 0; len < MAX_COPY; len++)
    {
      ...
      if (p != u.buf+7){ printf("abort_main "); 		abort (); }
      check (7, len, '\0');
