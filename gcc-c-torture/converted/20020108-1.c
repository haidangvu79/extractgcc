...
#if CHAR_BIT == 8
# define REPEAT_FN(COUNT) \
  if (CAT (ashift_qi_, COUNT) (0xff) != (u8) ((u8)0xff << COUNT)){ printf("abort_main "); 		abort (); }
  REPEAT_8;
# undef REPEAT_FN

# define REPEAT_FN(COUNT) \
  if (CAT (lshiftrt_qi_, COUNT) (0xff) != (u8) ((u8)0xff >> COUNT)){ printf("abort_main "); 		abort (); }
  REPEAT_8;
# undef REPEAT_FN

# define REPEAT_FN(COUNT) \
  if (CAT (ashiftrt_qi_, COUNT) (-1) != -1){ printf("abort_main "); 		abort (); }
  REPEAT_8;
# undef REPEAT_FN

# define REPEAT_FN(COUNT) \
  if (CAT (ashiftrt_qi_, COUNT) (0) != 0){ printf("abort_main "); 		abort (); }
  REPEAT_8;
# undef REPEAT_FN
#endif /* CHAR_BIT == 8 */
...
# define REPEAT_FN(COUNT)			\
  if (CAT (ashift_hi_, COUNT) (0xffff)		\
      != (u16) ((u16) 0xffff << COUNT)){ printf("abort_main "); 		abort (); }
  REPEAT_16;
# undef REPEAT_FN
...
# define REPEAT_FN(COUNT) \
  if (CAT (ashiftrt_hi_, COUNT) (-1) != -1){ printf("abort_main "); 		abort (); }
  REPEAT_16;
# undef REPEAT_FN

# define REPEAT_FN(COUNT) \
  if (CAT (ashiftrt_hi_, COUNT) (0) != 0){ printf("abort_main "); 		abort (); }
  REPEAT_16;
# undef REPEAT_FN
#endif /* CHAR_BIT == 8 || CHAR_BIT == 16 */
...
# define REPEAT_FN(COUNT)				\
  if (CAT (ashift_si_, COUNT) (0xffffffff)		\
      != (u32) ((u32) 0xffffffff << COUNT)){ printf("abort_main "); 		abort (); }
  REPEAT_32;
# undef REPEAT_FN
...
# define REPEAT_FN(COUNT) \
  if (CAT (ashiftrt_si_, COUNT) (-1) != -1){ printf("abort_main "); 		abort (); }
  REPEAT_32;
# undef REPEAT_FN

# define REPEAT_FN(COUNT) \
  if (CAT (ashiftrt_si_, COUNT) (0) != 0){ printf("abort_main "); 		abort (); }
  REPEAT_32;
# undef REPEAT_FN
#endif /* CHAR_BIT == 8 || CHAR_BIT == 16 || CHAR_BIT == 32 */
